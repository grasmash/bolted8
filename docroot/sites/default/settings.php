 ...
 * @endcode
 */
$settings['hash_salt'] = 'yBuUZ9zkt77TloKsSnq6ccsIjF8UCiC2UQkWejerZVgd293GUkBeuNW';
 ...
 */
if ($is_local_env) {
  if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_bolted8_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_bolted8_dd.inc';
  }
